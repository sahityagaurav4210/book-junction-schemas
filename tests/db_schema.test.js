...
describe('db_schema.test.js', function () {
  describe('create_admin.db_schema.test.js', function () {
    it('should validate create admin payload', function () {
      ...
      expect(Schema.db.adminModelSchema.createAdmin(payload)).toBe(undefined);
      expect(typeof Schema.db.adminModelSchema.createAdmin(payload)).toBe('undefined');
    });
    ...
    it('should not validate create admin payload with invalid password', function () {
      ...
      const result = Schema.db.adminModelSchema.createAdmin(payload);
